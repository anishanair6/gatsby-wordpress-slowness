...
export const injectResources = data => {
	if (data!=null && data.hasOwnProperty('wordpressPage')) {
		...
		if (data.wordpressPage.hasOwnProperty('resource_urls')) {
			data.wordpressPage.resource_urls.style.wordpress_3rdparty.forEach(function(style) {		
				useStyle ( style.url);
			});	
		}
		...
		if (data.wordpressPage.hasOwnProperty('resource_urls')) {
			data.wordpressPage.resource_urls.script.wordpress_3rdparty.forEach(function(script) {		
